...
const handleSubmitExcel = async () => {
  ...
  return (
    <section className="w-full min-h-screen py-8 flex justify-center items-center text-nigth-blue transition-all duration-500">
      {!escenarios ? (
        excelResponse ? (
          <div className="max-w-4xl min-h-[400px] w-full animate-fade-in">
            <ViewExcelVisor
              idExcel={excelResponse?.id}
          ...
          <div className="max-w-2xl w-full mx-4">
                    ...
                    <div className="flex gap-4 pt-4">
                      ...
                      >
                        <ArrowBack/> Volver
                          ...
                          <p className="flex flex-row items-center gap-4"><Save/> Guardar Proyecto</p>
                      </button>
                    </div>
                  </form>
                </div>
            ...
            <div className="text-center mt-8 animate-fade-in">
              <p className="text-sm text-gray-500">
                Tus archivos se procesan de forma segura y están disponibles
                solo para ti
              </p>
            </div>
          </div>
